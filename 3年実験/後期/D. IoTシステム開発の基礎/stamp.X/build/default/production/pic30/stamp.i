...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.10\pic\include\pic16f648a.h"
...
extern unsigned char outfg;
extern unsigned char outcoin;
...
extern char red_led[];
extern char status_bit[];

# 10 "pic30/extern.h"
extern void init(void);
extern void led_on(char bit1);
extern void led_off(char bit1);
extern char sw_read(void);
extern void DispStatus(char bit1);
extern void StampOut(int num);
extern int DispCoinA(int num);
extern int DispCoinB(int num);
extern void timer(char i);
extern void halt(void);
extern void interrupt isr(void);

# 13 "pic30/stamp.c"
__config("__CONFIG", "pic", "FOSC_HS & WDTE_OFF & PWRTE_ON & MCLRE_ON & BOREN_OFF & LVP_OFF & CPD_OFF & CP_OFF");
