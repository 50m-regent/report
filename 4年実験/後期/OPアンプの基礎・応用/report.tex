...
\section{微分回路}
    ...
    \subsection{基本微分回路}
        ...
        \begin{figure}[h]
            \centering
            % \includegraphics[0.7\hsize]{img/dif.eps}
            \caption{基本微分回路}
            \label{fig:dif}
        \end{figure}
    ...
    \subsection{実用微分回路}
        ...
        \begin{figure}[h]
            \centering
            % \includegraphics[0.7\hsize]{img/nice-dif.eps}
            \caption{実用微分回路}
            \label{fig:nice-dif}
        \end{figure}
...
\section{積分回路}
    ...
    \subsection{基本積分回路}
        ...
        \begin{figure}[h]
            \centering
            % \includegraphics[0.7\hsize]{img/int.eps}
            \caption{基本積分回路}
            \label{fig:int}
        \end{figure}
    ...
    \subsection{実用積分回路}
        ...
        \begin{figure}[h]
            \centering
            % \includegraphics[0.7\hsize]{img/nice-int.eps}
            \caption{実用積分回路}
            \label{fig:nice-int}
        \end{figure}
